(function registerPreviews() {
  ...
  /**
   * Decap charge la preview dans une iframe : un <link href> y échoue souvent.
   * On injecte le CSS en brut (URLs absolues pour les polices), puis les templates.
   */
  ...
  fetch(`${origin}/admin/preview-content.css?v=20260720b`, { cache: "no-store" })
    .then((response) => {
    ...
    .catch((error) => {
      ...
      window.CMS.registerPreviewStyle(
        `${origin}/admin/preview-content.css?v=20260720b`
      );
    })
    .finally(() => {
